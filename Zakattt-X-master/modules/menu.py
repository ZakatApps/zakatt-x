        ...
        if system.connection():
          ...
          if system.sudo != None:
            if os.path.exists(system.home+"/Tool-X"):
              ...
              os.system(system.sudo+" git clone https://github.com/ZakatApps/zakatt-x.git "+system.home+"/Zakat-X")
            ...
            if os.path.exists(system.home+"/Zakat-X"):
              ...
              os.system("git clone https://github.com/ZakatApps/zakatt-x.git "+system.home+"/Zakat-X")
            if os.path.exists(system.home+"/Zakat-X/install.aex"):
